      ...
      <section>
        <Container>
          <Row>
            ...
            <Col lg='6' md='6'>
              <div className="why__tasty__treatmb-4">
                <h2 className="tasty__treat-title">Why <span>
                Tasty Treat..?
                  </span></h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis tenetur, et impedit illo facere quisquam doloribus qui reiciendis molestias soluta nesciunt ad at quasi enim earum omnis voluptate dicta asperiores!</p>
                <ListGroup>
                  <ListGroupItem>
                 <p className="d-flex align-items-center gap-2"> <i className="ri-checkbox-circle-line"></i>Fresh and tasty foods</p>
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                  </ListGroupItem>

                  <ListGroupItem>
                  <p className="d-flex align-items-center gap-2"><i className="ri-checkbox-circle-line"></i>Quality support foods
                  </p>
                  <p>
