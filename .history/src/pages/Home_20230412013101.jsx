          ...
          <Row>
            ...
            <Col lg='6' md='6'>
              <div className="why__tasty__treat">
                <h2 className="tasty__treat-title mb-4">Why <span>
                Tasty Treat..?
                  </span></h2>
                <p className="tasty__treat-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis tenetur, et impedit illo facere quisquam doloribus qui reiciendis molestias soluta nesciunt ad at quasi enim earum omnis voluptate dicta asperiores!</p>
                <ListGroup className="mt-5">
                 ...
                 <p className="choose__us-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                  ...
                  <ListGroupItem className="border-0 ps-0">
                  <p className="choose__us-title d-flex align-items-center gap-2"><i className="ri-checkbox-circle-line"></i>Quality support foods
                  </p>
                  <p className="choose__us-desc">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, molestias.
                  </p>
                  </ListGroupItem>
      ...
      <section>
        <Container>
          <Row>
           ...
           <h5 className="testimonial__subtitle">Testimonials</h5>
           <h2 className="testimonial__title">What Our <span>Customers</span> are saying</h2>
           <p className="testimonial__desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores sint sit et quas modi, aspernatur alias nostrum in velit magnam praesentium aperiam iure distinctio possimus pariatur soluta exercitationem quasi perspiciatis.</p>
           </div>
            </Col>
            <Col lg='6' md='6'>
              <img src={networkImg} alt="testimonials-img" className="w-100"/>
            </Col>
          </Row>
        </Container>
      </section>
