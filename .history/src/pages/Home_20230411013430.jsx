        ...
        <Container>
          <Row>
            <Col lg='12' className='text-center'>
              ...
              <p className='mb-1 mt-4 feature__text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, voluptates?</p>
              <p className='feature__text'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum, omnis?</p>
            </Col>

            {
              featureData.map((item,index) => {
                return(
                  ...
                  <div className="feature__itemtext-center p-4">
