          ...
          <Col lg='6' md='6'>
            <div className="hero__content">
              ...
              <div className='d-flex align-items-center gap-5'>
                <p className='d-flex align-items-center gap-2'><span className='shippimg__icon'><i className="ri-car-line"></i></span> No shipping chagrge</p>
                <p className='d-flex align-items-center gap-2'><span className='shippimg__icon'><i className="ri-shield-check-line"></i></span>{" "}100% secure checkout</p>
              </div>
            </div>
          </Col>
